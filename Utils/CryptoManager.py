...
class Crypto:
	def __init__(self):
		self.server_key = bytes.fromhex("EB7C3639CA77E5BD6D5A7AF9FCFBF94AA9BBC5C5819CBBF2859AE60DE6CCD041")
		self.client_sk = bytes.fromhex("A1B2C3D4E5F60718293A4B5C6D7E8F90A1B2C3D4E5F60718293A4B5C6D7E8F90")
